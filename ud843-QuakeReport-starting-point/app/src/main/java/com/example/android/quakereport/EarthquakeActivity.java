...
//        earthquakes.add(new EarthquakeData("San Francisco",  5.5,"7 feb"));
//        earthquakes.add(new EarthquakeData("London",6.5,"9 feb 2018"));
//        earthquakes.add(new EarthquakeData("Tokyo",7.5,"9 jan 2018"));
//        earthquakes.add(new EarthquakeData("Mexico City" , 8.5, "10 Dec 2018"));
//        earthquakes.add(new EarthquakeData("Moscow",9.8,"24 Dec 2017"));
//        earthquakes.add(new EarthquakeData("Rio de Janeiro",1.1, "25 May 2016"));
//        earthquakes.add(new EarthquakeData("Paris" , 1.5 , "29 June 2016"));
        ...
        final DataAdapter dataAdapter = new DataAdapter(this,earthquakes);
        // Set the adapter on the {@link ListView}
        // so the list can be populated in the user interface
        earthquakeListView.setAdapter(dataAdapter);

        earthquakeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                // Find the current earthquake that was clicked on
                EarthquakeData currentEarthquake = dataAdapter.getItem(i);
