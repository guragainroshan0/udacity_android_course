...
public final class QueryUtils {
    ...
    public static ArrayList<EarthquakeData> extractEarthquakes() {
        ...
        try {
            ...
            {
                JSONObject currentEarthquake = (JSONObject) features.getJSONObject(i);

                JSONObject properties = (JSONObject) currentEarthquake.getJSONObject("properties");
                ...
                earthquakes.add(new EarthquakeData(location, mag, time,url));
